											...
											<div style="text-align:center; margin:0 15px 34px 15px">
												...
												<div style="margin-bottom: 10px">
													<a href="https://keenthemes.com" rel="noopener" target="_blank">
														<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/logo-1.svg" style="height: 35px" />
													</a>
												</div>
												<!--end:Logo-->
												<!--begin:Media-->
												<div style="margin-bottom: 15px">
													<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-positive-vote-1.svg" />
												</div>
												<!--end:Media-->
												<!--begin:Text-->
												...
												<!--end:Text-->
												<!--begin:Action-->
												<a href='<?php echo isset($validate) && $validate != '' ? $validate : base_url() . 'oops';?>' target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">Activate Account</a>
												<!--begin:Action-->
											</div>
											<!--end:Email content-->
										</td>
											...
											<div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
												...
												<div style="display:flex">
													...
													<div style="display: flex; justify-content: center; align-items: center; width:40px; height:40px; margin-right:13px">
														<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-polygon.svg" />
									...
									<tr>
										<td align="center" valign="center" style="text-align:center; padding-bottom: 20px;">
											<a href="#" style="margin-right:10px">
												<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-linkedin.svg" />
											</a>
											<a href="#" style="margin-right:10px">
												<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-dribbble.svg" />
											</a>
											<a href="#" style="margin-right:10px">
												<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-facebook.svg" />
											</a>
											<a href="#">
												<img alt="Logo" src="<?php echo base_url();?>metronic/dist/assets/media/email/icon-twitter.svg" />
											</a>
										</td>
									</tr>
									<tr>
